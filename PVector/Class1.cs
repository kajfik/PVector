...
namespace PVectorLibrary
{
    ...
    public class PVector
    {
         ...
         * @return the random PVector
         */
        static public PVector random2D(PVector target, Random rnd)
        {
            return fromAngle((float)(rnd.NextDouble() * Math.PI * 2), target);
        }
         ...
         */
        static public PVector random3D(Random rnd)
        {
            return random3D(null, rnd);
        }
         ...
         * @return the random PVector
         */
        static public PVector random3D(PVector target, Random rnd)
        {
            float angle;
            float vz;
            angle = (float)(rnd.NextDouble() * Math.PI * 2);
            vz = (float)(rnd.NextDouble() * 2 - 1);
